...
screen mission_select_screen():
    ...
    viewport: 
        ...
        fixed:
            ...
            imagebutton auto "Mission_select_screen/entrance_%s.png" focus_mask True :
                if entrance:
                
                        action Return(entrance.jumplabel)
                else:
                    action NullAction()

            default laundryroom = providemission_info("laundryroom")
            imagebutton auto "Mission_select_screen/laundryroom_%s.png" focus_mask True :
                if laundryroom:
                    
                        action Return(laundryroom.jumplabel)
                else:
                    action NullAction()

            default garage = providemission_info("garage")
            imagebutton auto "Mission_select_screen/garage_%s.png" focus_mask True :
                if garage:
                    
                        action Return(garage.jumplabel)
                else:
                    action NullAction()
            
            default storage = providemission_info("storage")
            imagebutton auto "Mission_select_screen/storage_%s.png" focus_mask True :
                if storage:
                    
                        action Return(storage.jumplabel)
                else:
                    action NullAction()
            default livingroom = providemission_info("livingroom")
            imagebutton auto "Mission_select_screen/livingroom_%s.png" focus_mask True:
                if livingroom:
                    
                        action Return(livingroom.jumplabel)
                else:
                    action NullAction()
            
            default kitchen = providemission_info("kitchen")
            imagebutton auto "Mission_select_screen/kitchen_%s.png" focus_mask True :
                if kitchen:
                    
                        action Return(kitchen.jumplabel)
                else:
                    action NullAction()
